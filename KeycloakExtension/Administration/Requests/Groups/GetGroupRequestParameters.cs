...
namespace Identity.Keycloak.Auth.Extension.Administration.Requests.Groups;

/// <summary>
/// Optional request parameters for the <see cref="Identity.Keycloak.Auth.Extension.Administration.IKeycloakGroupClient.GetGroups"/> endpoint.
